    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          >
            When you choose Presidency University, you are choosing more than a
            degree. You are choosing a community, a city, and a career advantage
            that few universities in Asia can match.
          </motion.p>
          <motion.ul
          ...
          >
            <li>
              100+ undergraduate, postgraduate, and doctoral programmes across
              10 Schools
            </li>
            <li>
              Accredited by NAAC and approved by the University Grants
              Commission (UGC), Government of India
            </li>
            <li>
              Ranked in NIRF, QS, and Times Higher Education (THE) rankings
              [CONFIRM current year rankings]
            </li>
            <li>
              Dedicated Office of International Affairs (OIA) with support from
              application to graduation
            </li>
            <li>
              International MoU partnerships with universities across the USA,
              UK, Germany, France, Taiwan, Malaysia, and Japan
            </li>
            <li>
              3+1+1 dual-qualification pathway — complete your final year and a
              Master’s abroad
            </li>
            <li>
              Safe, fully-equipped on-campus hostel accommodation for male and
              female students
            </li>
            <li>
              Located in Bangalore — home to the Indian offices of Amazon,
              Google, Microsoft, Infosys, Wipro, and hundreds more
            </li>
          </motion.ul>
          <div className="flex ">
