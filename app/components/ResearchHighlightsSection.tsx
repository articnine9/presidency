...
export function ResearchHighlightsSection() {
  ...
  return (
    <section className="py-10 md:py-16 lg:py-24 bg-[#EEF1F5]">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-10">
        ...
        <div className="grid md:grid-cols-2 gap-4 md:gap-8">
          {sections.map((item, index) => (
            ...
            >
              {/* IMAGE */}
              <div className="w-full sm:w-1/2 h-[200px] sm:h-[240px] md:h-[290px] overflow-hidden">
                <img
                  src={item.image}
                  alt={item.title}
              ...
              {/* TEXT */}
              <div
                className={`${item.bg} text-white sm:w-1/2 w-full p-4 md:p-6 flex flex-col justify-center`}
              >
                <h3 className="text-base md:text-lg lg:text-xl mb-2 leading-snug">
                  {item.title}
                </h3>
