...
const steps = [
  {
    ...
    description:
      "Fill out our online application form and submit required documents",
  },
  {
    icon: UserCheck,
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg max-w-3xl mx-auto">
            Our streamlined admissions process makes it easy to join our
            community of learners. Follow these simple steps to begin your
            educational journey.
          </p>
        </div>
            ...
            return (
              <div key={index} className="relative">
                ...
                <div className="relative bg-gradient-to-br from-[#1e3a5f] to-[#2a4a6f] rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                  {/* Step number badge */}
                  <div className="absolute -top-4 -right-4 w-12 h-12 bg-[#ff8c42] rounded-lg flex items-center justify-center text-white shadow-lg">
                    {index + 1}
                  </div>
        ...
        <div className="relative bg-gradient-to-r from-[#ff8c42] to-[#e67a32] rounded-3xl p-8 lg:p-12 shadow-2xl overflow-hidden">
          {/* Decorative circles */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-white rounded-lg blur-3xl opacity-10"></div>
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#1e3a5f] rounded-lg blur-3xl opacity-10"></div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/90 text-lg">
                Apply now and take the first step towards a bright future at
                Presidency University International.
              </p>
            </div>

            <button className="flex-shrink-0 bg-white text-[#ff8c42] px-8 py-4 rounded-lg hover:bg-gray-100 transition-all transform hover:scale-105 shadow-lg flex items-center gap-2">
              Apply Now
              <ArrowRight size={20} />
            </button>
          </div>
